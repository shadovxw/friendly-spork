...
import TextReveal from './TextReveal'; // <--- NEW IMPORT
...
const AboutSection = () => {
  ...
  // This is the text that will light up as you scroll
  const philosophy = "I believe code is modern-day alchemy. We take raw logic and transform it into living, breathing experiences. My work exists at the intersection of precision engineering and digital chaos.";
  
  const skills = ["React.js", "Three.js", "Tailwind", "Node.js", "Python", "Unreal Engine", "Blender", "AWS"];
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Adjusted move amount based on screen size
  ...
  return (
    <section ref={containerRef} id="about" className="relative w-full h-[300vh] bg-neutral-900">
        ...
        >
            ...
            <div className="shrink-0 w-[85vw] md:w-[45vw] flex flex-col justify-center pr-10">
                <div className="mb-10 border-l-2 border-cyan-500 pl-8">
                    <BlurReveal>
                        <h2 className="text-sm font-bold tracking-[0.5em] text-cyan-400 uppercase mb-2">The Personnel</h2>
                    </BlurReveal>
                    <BlurReveal delay={0.2}>
            ...
            <div className="shrink-0 w-[85vw] md:w-[600px] h-[500px] md:h-[600px] bg-black border border-neutral-800 p-8 md:p-12 flex flex-col justify-between group hover:border-cyan-500/50 transition-colors duration-500">
                <div>
                    <BlurReveal><div className="text-8xl font-black text-neutral-800 mb-6">01</div></BlurReveal>
                    <BlurReveal delay={0.1}><h4 className="text-3xl font-bold text-white mb-6">The Origin.</h4></BlurReveal>
                    <BlurReveal delay={0.2}><p className="text-gray-400 leading-relaxed text-lg">I don't just write code; I construct logic. My background in computer science is fused with a passion for abstract expressionism.</p></BlurReveal>
                </div>
            ...
            <div className="shrink-0 w-[85vw] md:w-[600px] h-[500px] md:h-[600px] bg-black border border-neutral-800 p-8 md:p-12 flex flex-col justify-between group hover:border-purple-500/50 transition-colors duration-500">
                <div>
                    <BlurReveal><div className="text-8xl font-black text-neutral-800 mb-6">02</div></BlurReveal>
                    <BlurReveal delay={0.1}><h4 className="text-3xl font-bold text-white mb-6">The Arsenal.</h4></BlurReveal>
                    <BlurReveal delay={0.2}>
            ...
            <div className="shrink-0 w-[85vw] md:w-[600px] h-[500px] md:h-[600px] bg-black border border-neutral-800 p-8 md:p-12 flex flex-col justify-between group hover:border-white/50 transition-colors duration-500">
                <div>
                    <BlurReveal><div className="text-8xl font-black text-neutral-800 mb-6">03</div></BlurReveal>
                    <BlurReveal delay={0.1}><h4 className="text-3xl font-bold text-white mb-6">The Chaos.</h4></BlurReveal>
                    <BlurReveal delay={0.2}><p className="text-gray-400 leading-relaxed text-lg">"Perfect is boring." I embrace digital artifacts, glitches, and organized chaos. My goal is to create web experiences that feel alive.</p></BlurReveal>
                </div>
