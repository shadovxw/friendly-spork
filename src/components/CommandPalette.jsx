...
const CommandPalette = () => {
  ...
  const commands = [
    { id: 'home', label: 'Go Home', icon: '🏠', action: () => window.location.href = '/' },
    { id: 'projects', label: 'View Projects', icon: '⚡', action: () => document.getElementById('projects').scrollIntoView({ behavior: 'smooth' }) },
    { id: 'about', label: 'Read Philosophy', icon: '🧠', action: () => document.getElementById('about').scrollIntoView({ behavior: 'smooth' }) },
    { id: 'contact', label: 'Send Signal', icon: '📡', action: () => document.querySelector('button[class*="Contact"]').click() }, // Triggers your existing modal
